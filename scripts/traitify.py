...
class Traitify:
  ...
  def get_personality_types(self, assessment_id):
    ...
    return { "personality_blend": PersonalityBlend(data[0].get("personality_blend")), "personality_types": ScoredPersonalityType.from_attr_list(data[0].get("personality_types")) }
